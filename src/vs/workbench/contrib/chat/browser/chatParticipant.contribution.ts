...
import { IViewContainersRegistry, IViewsRegistry, ViewContainerLocation, Extensions as ViewExtensions } from '../../../common/views.js'; // [SKYCODE] IViewDescriptor removed — Copilot Chat view disabled
