...
// --- SKYCODE_FORK_BEGIN: removed ChatCodeActionsProvider import (Copilot Code Actions disabled) ---
...
export class ChatSetupContribution extends Disposable implements IWorkbenchContribution {
	...
	private registerSetupAgents(context: ChatEntitlementContext, controller: Lazy<ChatSetupController>): void {
		...
		const updateRegistration = () => {
			...
			// --- SKYCODE_FORK_BEGIN: disable Copilot Code Actions Provider ---
			// Skycode extension provides its own AI code actions via Quick Fix menu.
			{
