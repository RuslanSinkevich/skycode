...
/**
 * Combines API request start and finish messages in an array of SkycodeMessages.
 *
 ...
 * @returns A new array of SkycodeMessage objects with API requests combined.
 *
 * @example
 * const messages = [
 ...
 */
export function combineApiRequests(messages: SkycodeMessage[]): SkycodeMessage[] {
	const combinedApiRequests: SkycodeMessage[] = []
