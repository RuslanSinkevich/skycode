...
describe("State Keys Type Safety", () => {
	...
	describe("Type Exports", () => {
		...
		it("should export usable key types", () => {
			...
			const localKey: LocalStateKey = "localSkycodeRulesToggles"
		...
		it("should have LocalState keys map to SkycodeRulesToggles", () => {
			const localState: Partial<LocalState> = {
				localSkycodeRulesToggles: {},
				localCursorRulesToggles: { "some-rule": true },
			}
			expect(localState.localSkycodeRulesToggles).to.deep.equal({})
		})
	})
	...
	describe("Edge Cases", () => {
		...
		it("should handle keys with special characters", () => {
			// The skycode:skycodeAccountId key has a colon
			expect(SecretKeys).to.include("skycode:skycodeAccountId")
			expect(isSecretKey("skycode:skycodeAccountId")).to.be.true
		})
