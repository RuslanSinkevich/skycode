...
export interface SkycodeStorageChangeEvent {
	readonly key: string
}

export type StorageEventListener = (event: SkycodeStorageChangeEvent) => Promise<void>
 ...
 */
export abstract class SkycodeStorage {
	/**
	 * The name of the storage, used for logging purposes.
	 */
	protected name = "SkycodeStorage"
	/**
...
/**
 * A simple in-memory implementation of SkycodeStorage using a Map.
 */
export class InMemorySkycodeStorage extends SkycodeStorage {
	/**
