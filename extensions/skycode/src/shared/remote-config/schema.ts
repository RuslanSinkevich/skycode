...
// Skycode Provider model schema with per-model settings
export const SkycodeModelSchema = z.object({
	id: z.string(), // The model ID is required
})

// Skycode Provider specific settings
export const SkycodeSettingsSchema = z.object({
	// A list of the allowed models with their settings
	models: z.array(SkycodeModelSchema).optional(),
})
...
const ProviderSettingsSchema = z.object({
	...
	Skycode: SkycodeSettingsSchema.optional(),
...
// Settings for a global skycode rules or workflow file.
