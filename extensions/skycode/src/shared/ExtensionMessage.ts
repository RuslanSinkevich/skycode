...
import { SkycodeFeatureSetting } from "./SkycodeFeatureSetting"
import { IndexingConfig, IndexingProgress } from "./IndexingTypes"
import { BannerCardData } from "./skycode/banner"
import { SkycodeRulesToggles } from "./skycode-rules"
import { DictationSettings } from "./DictationSettings"
import { FocusChainSettings } from "./FocusChainSettings"
import { HistoryItem } from "./HistoryItem"
import { McpDisplayMode } from "./McpDisplayMode"
import { SkycodeMessageModelInfo } from "./messages"
import { OnboardingModelGroup } from "./proto/skycode/state"
...
export const COMMAND_CANCEL_TOKEN = "__skycode_command_cancel__"
...
export interface ExtensionState {
	...
	skycodeMessages: SkycodeMessage[]
	...
	version: string
	distinctId: string
	globalSkycodeRulesToggles: SkycodeRulesToggles
	localSkycodeRulesToggles: SkycodeRulesToggles
	localWorkflowToggles: SkycodeRulesToggles
	globalWorkflowToggles: SkycodeRulesToggles
	localCursorRulesToggles: SkycodeRulesToggles
	localWindsurfRulesToggles: SkycodeRulesToggles
	remoteRulesToggles?: SkycodeRulesToggles
	remoteWorkflowToggles?: SkycodeRulesToggles
	localAgentsRulesToggles: SkycodeRulesToggles
	mcpResponsesCollapsed?: boolean
	strictPlanModeEnabled?: boolean
	yoloModeToggled?: boolean
	useAutoCondense?: boolean
	skycodeWebToolsEnabled?: SkycodeFeatureSetting
	worktreesEnabled?: SkycodeFeatureSetting
	...
	multiRootSetting: SkycodeFeatureSetting
...
export interface SkycodeSayHook {
...
export interface SkycodeSayBrowserAction {
	action: BrowserAction
	coordinate?: string
	text?: string
}

export interface SkycodeSayGenerateExplanation {
	title: string
	fromRef: string
	toRef: string
...
export interface SkycodeAskUseMcpServer {
	serverName: string
...
export interface SkycodePlanModeResponse {
	response: string
	options?: string[]
	selected?: string
}

export interface SkycodeAskQuestion {
	question: string
	options?: string[]
	selected?: string
}

export interface SkycodeAskNewTask {
	context: string
}

export interface SkycodeApiReqInfo {
	request?: string
	tokensIn?: number
	tokensOut?: number
	cacheWrites?: number
	cacheReads?: number
	cost?: number
	cancelReason?: SkycodeApiReqCancelReason
...
export type SkycodeApiReqCancelReason = "streaming_failed" | "user_cancelled" | "retries_exhausted"
