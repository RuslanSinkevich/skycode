 ...
 */
const useDevEnv = process.env.IS_DEV === "true" || process.env.SKYCODE_ENVIRONMENT === "local"
...
export const posthogConfig: PostHogClientConfig = {
	...
	host: "", // TODO: настроить свой PostHog proxy или оставить пустым для отключения
