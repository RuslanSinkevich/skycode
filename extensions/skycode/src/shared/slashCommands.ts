...
export const BASE_SLASH_COMMANDS: SlashCommand[] = [
	...
	{
		name: "newrule",
		description: "Create a new Skycode rule based on your conversation",
		section: "default",
		cliCompatible: true,
	},
	{
		name: "reportbug",
		description: "Create a Github issue with Skycode",
		section: "default",
		cliCompatible: true,
	},
	{
	...
	{
		name: "subagent",
		description: "Invoke a Skycode CLI subagent for focused research tasks",
		section: "default",
		cliCompatible: true,
	},
]
