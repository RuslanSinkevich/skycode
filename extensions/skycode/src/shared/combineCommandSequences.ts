...
/**
 * Combines sequences of command and command_output messages in an array of SkycodeMessages.
 *
 * This function processes an array of SkycodeMessages objects, looking for sequences
 ...
 * their text contents.
 *
 * @param messages - An array of SkycodeMessage objects to process.
 * @returns A new array of SkycodeMessage objects with command sequences combined.
 *
 * @example
 * const messages: SkycodeMessage[] = [
 ...
 */
export function combineCommandSequences(messages: SkycodeMessage[]): SkycodeMessage[] {
	const combinedCommands: SkycodeMessage[] = []
