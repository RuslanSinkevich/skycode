...
import type { SkycodeToolResponseContent } from "@shared/messages"
...
export interface CommandExecutorCallbacks {
	...
	/**
	 * Update a skycode message by index
	 * Supports updating commandCompleted status and/or text content
	 */
	updateSkycodeMessage: (index: number, updates: { commandCompleted?: boolean; text?: string }) => Promise<void>
	/** Get skycode messages array */
	getSkycodeMessages: () => Array<{ ask?: string; say?: string; text?: string }>
...
export interface OrchestrationResult {
	...
	result: SkycodeToolResponseContent
