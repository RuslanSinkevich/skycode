...
function setupHostProvider(extensionContext: any, extensionDir: string, dataDir: string) {
	...
	// skycode-core expects the binaries to be unpacked in the directory where it is running.
...
/**
 * Gracefully shutdown the skycode-core process by:
...
function showHelp() {
	Logger.log(`
Skycode Core - Standalone Server

Usage: node skycode-core.js [options]
...
Options:
  ...
  -c, --config <path>            Directory for Skycode data storage (default: ~/.skycode)
