...
import { CreateHookRequest, DeleteHookRequest, ToggleHookRequest } from "../shared/proto/skycode/file"
...
describe("Hook Management", () => {
	...
	beforeEach(async () => {
		...
		globalHooksDir = path.join(tempDir, "global", "Documents", "Skycode", "Hooks")
		workspaceHooksDir = path.join(tempDir, "workspace", ".skycoderules", "hooks")
	...
	describe("Edge Cases", () => {
		it("should handle missing .skycoderules directory gracefully", async function () {
			this.timeout(5000)
