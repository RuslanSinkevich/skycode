...
import type { SkycodeAPI } from "../exports/skycode"
import { setVscodeHostProviderMock } from "./host-provider-test-utils"

describe("SkycodeAPI Core Functionality", () => {
	let api: SkycodeAPI
	...
	beforeEach(async () => {
		...
		// Create a mock controller that matches what the real createSkycodeAPI expects
		...
		// Create API instance
		api = createSkycodeAPI(mockController)
	})
