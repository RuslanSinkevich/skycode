...
import type { SkycodeError } from "../SkycodeError"
...
export interface IErrorProvider {
	 ...
	 * @param error The error to log (Error or SkycodeError)
	 * @param properties Optional additional properties to attach
	 */
	logException(error: Error | SkycodeError, properties?: Record<string, unknown>): void
