...
import { SkycodeError } from "./SkycodeError"
import { ErrorProviderFactory } from "./ErrorProviderFactory"
import { IErrorProvider } from "./providers/IErrorProvider"

/**
 * ErrorService handles error logging and tracking for the Skycode extension
...
export class ErrorService {
	...
	public logException(error: Error | SkycodeError, properties?: Record<string, unknown>): void {
	...
	public toSkycodeError(rawError: unknown, modelId?: string, providerId?: string): SkycodeError {
		const transformed = SkycodeError.transform(rawError, modelId, providerId)
