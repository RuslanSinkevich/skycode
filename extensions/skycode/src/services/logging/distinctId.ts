 ...
 */
export const _GENERATED_MACHINE_ID_KEY = "skycode.generatedMachineId"
 ...
 * This is updated to Skycode User ID when authenticated.
 */
 ...
 * If authenticated, this will be the Skycode User ID.
