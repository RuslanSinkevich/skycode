...
export class OpenTelemetryTelemetryProvider implements ITelemetryProvider {
	...
	constructor(
		...
		if (meterProvider) {
			this.meter = meterProvider.getMeter("skycode")
		}

		if (loggerProvider) {
			this.logger = loggerProvider.getLogger("skycode")
		}
	...
	public identifyUser(userInfo: SkycodeAccountUserInfo, properties: TelemetryProperties = {}): void {
