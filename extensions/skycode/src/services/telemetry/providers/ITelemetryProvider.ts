...
import type { SkycodeAccountUserInfo } from "../../auth/AuthService"
...
export interface ITelemetryProvider {
	 ...
	 */
	identifyUser(userInfo: SkycodeAccountUserInfo, properties?: TelemetryProperties): void
	 ...
	 * @param name Metric name (e.g., "skycode.tokens.input")
	 ...
	 * Providers that don't support metrics may implement this as a no-op.
	 * @param name Metric name (e.g., "skycode.api.duration_seconds")
	 ...
	 * Providers that don't support metrics may implement this as a no-op.
	 * @param name Metric name (e.g., "skycode.workspace.active_roots")
