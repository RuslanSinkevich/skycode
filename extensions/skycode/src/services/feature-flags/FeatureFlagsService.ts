import { clearOnboardingModelsCache, getSkycodeOnboardingModels } from "@/core/controller/models/getSkycodeOnboardingModels"
import type { OnboardingModel } from "@/shared/proto/skycode/state"
...
export class FeatureFlagsService {
	...
	public async poll(userId: string | null): Promise<void> {
		...
		getSkycodeOnboardingModels() // Refresh onboarding models cache if relevant flag changed
	}
