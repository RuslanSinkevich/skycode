...
export class Session {
	...
	private _messages: SkycodeMessage[] = []
	...
	get messages(): ReadonlyArray<SkycodeMessage> {
	...
	addMessage(message: SkycodeMessage): void {
	...
	updateMessage(ts: number, patch: Partial<SkycodeMessage>): void {
