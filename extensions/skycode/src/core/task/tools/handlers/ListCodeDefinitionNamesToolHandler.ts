...
export class ListCodeDefinitionNamesToolHandler implements IFullyManagedTool {
	readonly name = SkycodeDefaultTool.LIST_CODE_DEF
	...
	async execute(config: TaskConfig, block: ToolUse): Promise<ToolResponse> {
		...
		const result = await parseSourceCodeForDefinitionsTopLevel(absolutePath, config.services.skycodeIgnoreController)
