...
export interface IToolHandler {
	readonly name: SkycodeDefaultTool
...
export class SharedToolHandler implements IFullyManagedTool {
	constructor(
		public readonly name: SkycodeDefaultTool,
...
export class ToolExecutorCoordinator {
	...
	getHandler(toolName: string): IToolHandler | undefined {
		...
		if (toolName.includes(SKYCODE_MCP_TOOL_IDENTIFIER)) {
			toolName = SkycodeDefaultTool.MCP_USE
		}
