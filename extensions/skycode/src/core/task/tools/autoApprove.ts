...
export class AutoApprove {
	...
	shouldAutoApproveTool(toolName: SkycodeDefaultTool): boolean | [boolean, boolean] {
		if (this.stateManager.getGlobalSettingsKey("yoloModeToggled")) {
			switch (toolName) {
			case SkycodeDefaultTool.FILE_READ:
			case SkycodeDefaultTool.LIST_FILES:
			case SkycodeDefaultTool.LIST_CODE_DEF:
			case SkycodeDefaultTool.SEARCH:
			case SkycodeDefaultTool.NEW_RULE:
			case SkycodeDefaultTool.FILE_NEW:
			case SkycodeDefaultTool.FILE_EDIT:
			case SkycodeDefaultTool.APPLY_PATCH:
			case SkycodeDefaultTool.EDIT_NOTEBOOK:
			case SkycodeDefaultTool.FILE_DELETE:
			case SkycodeDefaultTool.BASH:
				return [true, true]

			case SkycodeDefaultTool.BROWSER:
			case SkycodeDefaultTool.WEB_FETCH:
			case SkycodeDefaultTool.WEB_SEARCH:
			case SkycodeDefaultTool.MCP_ACCESS:
			case SkycodeDefaultTool.MCP_USE:
				return true
			}
		}
