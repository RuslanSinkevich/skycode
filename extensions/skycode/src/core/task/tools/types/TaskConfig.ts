...
import type { SkycodeContent } from "@shared/messages/content"
...
import type { DiffSystem } from "../../../diff-v2"
...
export interface TaskServices {
	...
	diffSystem: DiffSystem | null // DiffSystem V2 (Proposed API)
}
...
export interface TaskCallbacks {
	...
	sayAndCreateMissingParamError: (toolName: SkycodeDefaultTool, paramName: string, relPath?: string) => Promise<any>
