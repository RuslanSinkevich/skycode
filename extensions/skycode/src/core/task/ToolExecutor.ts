...
import { SkycodeAsk, SkycodeSay } from "@shared/ExtensionMessage"
import { SkycodeContent } from "@shared/messages/content"
...
export class ToolExecutor {
	...
	private shouldAutoApproveTool(toolName: SkycodeDefaultTool): boolean | [boolean, boolean] {
		return this.autoApprover.shouldAutoApproveTool(toolName)
	}

	private async shouldAutoApproveToolWithPath(
		blockname: SkycodeDefaultTool,
	...
	private registerToolHandlers(): void {
		const validator = new ToolValidator(this.skycodeIgnoreController)
		...
		this.coordinator.register(new CodebaseSearchToolHandler())
		...
		this.coordinator.register(writeHandler) // registers as "write_to_file" (SkycodeDefaultTool.FILE_NEW)
		this.coordinator.register(new SharedToolHandler(SkycodeDefaultTool.FILE_EDIT, writeHandler))
		this.coordinator.register(new SharedToolHandler(SkycodeDefaultTool.NEW_RULE, writeHandler))
		// Simplified edit tools (for weaker models)
		this.coordinator.register(new SharedToolHandler(SkycodeDefaultTool.DELETE_BLOCK, writeHandler))
		this.coordinator.register(new SharedToolHandler(SkycodeDefaultTool.REPLACE_TEXT, writeHandler))
	 ...
	 */
	private static readonly PLAN_MODE_RESTRICTED_TOOLS: SkycodeDefaultTool[] = [
	 ...
	 */
	private static readonly ASK_MODE_RESTRICTED_TOOLS: SkycodeDefaultTool[] = [
		SkycodeDefaultTool.FILE_NEW,
		SkycodeDefaultTool.FILE_EDIT,
		SkycodeDefaultTool.NEW_RULE,
		SkycodeDefaultTool.APPLY_PATCH,
	 ...
	 */
	private static readonly CHAT_MODE_RESTRICTED_TOOLS: SkycodeDefaultTool[] = [
		SkycodeDefaultTool.FILE_NEW,
		SkycodeDefaultTool.FILE_EDIT,
		SkycodeDefaultTool.NEW_RULE,
		SkycodeDefaultTool.APPLY_PATCH,
	 ...
	 */
	private static readonly LIGHTWEIGHT_MODE_RESTRICTED_TOOLS: SkycodeDefaultTool[] = [
		SkycodeDefaultTool.BASH,
		SkycodeDefaultTool.FILE_EDIT,
		SkycodeDefaultTool.APPLY_PATCH,
	 ...
	 */
	private isPlanModeToolRestricted(toolName: SkycodeDefaultTool): boolean {
