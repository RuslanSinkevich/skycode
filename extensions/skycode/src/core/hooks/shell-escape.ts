 ...
 *
 * Use cases:
 * - Global hooks directory: ~/Documents/Skycode/Hooks/
 * - Workspace hooks: /path/to/My Project/.skycoderules/hooks/
 * - Multi-root workspaces: each root's .skycoderules/hooks/
 *
 * Examples:
