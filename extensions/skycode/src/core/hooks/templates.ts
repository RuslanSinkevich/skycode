...
# 
# Input: { taskId, taskStart: { task: string }, skycodeVersion, timestamp, ... }
...
# 
# Input: { taskId, taskResume: { task: string }, skycodeVersion, timestamp, ... }
# Output: { cancel: boolean, contextModification?: string, errorMessage?: string }
# 
# Use cases:
...
# 
# Input: { taskId, taskCancel: { task: string }, skycodeVersion, timestamp, ... }
# Output: { cancel: boolean, contextModification?: string, errorMessage?: string }
# 
# Use cases:
...
# 
# Input: { taskId, taskComplete: { task: string }, skycodeVersion, timestamp, ... }
# Output: { cancel: boolean, contextModification?: string, errorMessage?: string }
# 
# Use cases:
...
# 
# Executes when the user submits a prompt to Skycode.
# 
# Input: { taskId, userPromptSubmit: { prompt: string }, skycodeVersion, timestamp, ... }
# Output: { cancel: boolean, contextModification?: string, errorMessage?: string }
# 
# Use cases:
