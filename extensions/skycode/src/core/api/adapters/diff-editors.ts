 ...
 */
export function convertApplyPatchToolCalls(messages: Array<SkycodeStorageMessage>): Array<SkycodeStorageMessage> {
 ...
 */
export function convertWriteToFileToolCalls(messages: Array<SkycodeStorageMessage>): Array<SkycodeStorageMessage> {
	// Map to track tool_use_id to converted tool info and original input
