import type { ToggleCursorRuleRequest } from "@shared/proto/skycode/file"
 ...
 */
export async function toggleCursorRule(controller: Controller, request: ToggleCursorRuleRequest): Promise<SkycodeRulesToggles> {
