import { SkycodeRulesToggles, RuleScope, ToggleWorkflowRequest } from "@shared/proto/skycode/file"
 ...
 */
export async function toggleWorkflow(controller: Controller, request: ToggleWorkflowRequest): Promise<SkycodeRulesToggles> {
	...
	return SkycodeRulesToggles.create({ toggles: toggles })
}
