import type { ToggleAgentsRuleRequest } from "@shared/proto/skycode/file"
import { SkycodeRulesToggles } from "@shared/proto/skycode/file"
 ...
 */
export async function toggleAgentsRule(controller: Controller, request: ToggleAgentsRuleRequest): Promise<SkycodeRulesToggles> {
	...
	return SkycodeRulesToggles.create({
