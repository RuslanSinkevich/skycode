 ...
 *
 * Shortcuts:
 *   skycode.diff.nextHunk      — Navigate to next pending hunk (cross-file)
 *   skycode.diff.prevHunk      — Navigate to previous pending hunk (cross-file)
 *   skycode.diff.acceptCurrent — Accept hunk at cursor
 *   skycode.diff.rejectCurrent — Reject hunk at cursor
 */
...
export class KeyboardNavigation implements vscode.Disposable {
  ...
  registerCommands(): void {
    this.disposables.push(
      vscode.commands.registerCommand('skycode.diff.nextHunk', () => this.nextHunk()),
      vscode.commands.registerCommand('skycode.diff.prevHunk', () => this.prevHunk()),
      vscode.commands.registerCommand('skycode.diff.acceptCurrent', () => this.acceptCurrent()),
      vscode.commands.registerCommand('skycode.diff.rejectCurrent', () => this.rejectCurrent()),
    );
  }
