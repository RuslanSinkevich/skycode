...
export class DiffStore implements vscode.Disposable {
  private static readonly RG_KEY = 'skycode.diff.v3.responseGroups';
  private static readonly FC_KEY = 'skycode.diff.v3.fileChanges';
  private static readonly HUNKS_KEY = 'skycode.diff.v3.hunks';
