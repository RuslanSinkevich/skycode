...
export class StateStorage {
  private static readonly PENDING_CHANGES_KEY = 'skycode.pendingChanges';
  private static readonly FILE_UUIDS_KEY = 'skycode.fileUuids';
  private static readonly ACTIVE_CHECKPOINTS_KEY = 'skycode.activeCheckpoints';
  private static readonly PENDING_FILE_CREATES_KEY = 'skycode.pendingFileCreates';
