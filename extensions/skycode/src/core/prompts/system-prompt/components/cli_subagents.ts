...
skycode "find all React components that use the useState hook and list their names"

# Analyze code structure
skycode "analyze the authentication flow. Reverse trace through all relevant functions and methods, and provide a summary of how it works. Include file/class references in your summary."

# Gather targeted information
skycode "list all API endpoints and their HTTP methods"

# Summarize directories
skycode "summarize the purpose of all files in the src/services directory"

# Research implementations
skycode "find how error handling is implemented across the application"
\`\`\`
...
- If files you want to read are large or complicated, use Skycode CLI agents for exploration before instead of reading these files.`
