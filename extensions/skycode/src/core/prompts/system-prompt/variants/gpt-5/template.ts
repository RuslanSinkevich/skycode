...
- For understanding how features are implemented, finding related logic, or exploring unfamiliar code, prefer codebase_search first — it finds code by meaning and context. Use search_files for exact text patterns, identifiers, and regex lookups. If codebase_search returns weak results, fall back to search_files with concrete keywords.
