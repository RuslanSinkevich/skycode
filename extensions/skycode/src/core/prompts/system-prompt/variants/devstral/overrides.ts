...
export const DEVSTRAL_AGENT_ROLE_TEMPLATE = (context: SystemPromptContext) => {
	...
	return `You are Skycode AI, a highly skilled software engineer with extensive knowledge in many programming languages, frameworks, design patterns, and best practices.${thinkLanguageInstruction}
`
}
