...
- For semantic questions about where logic is implemented or how features work, prefer codebase_search first. For exact text patterns and identifiers, use search_files. Both are preferred over using grep in the terminal. If you are directly instructed to use grep, ensure your search patterns are targeted and not too vague to prevent extremely large outputs.
...
**Research Activities:**
- Use codebase_search, read_file, search_files, and list_code_definition_names extensively to understand architecture, patterns, and conventions
