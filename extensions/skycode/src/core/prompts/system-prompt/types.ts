...
export interface PromptVariant {
	...
	// Tool configuration
	readonly tools?: readonly SkycodeDefaultTool[] // Ordered list of tools to include
	readonly toolOverrides?: Readonly<Partial<Record<SkycodeDefaultTool, ConfigOverride>>> // Tool customizations
}
...
export interface MutablePromptVariant {
	...
	tools?: SkycodeDefaultTool[]
	toolOverrides?: Partial<Record<SkycodeDefaultTool, ConfigOverride>>
}
...
export interface PromptConfig {
	...
	readonly tools?: readonly SkycodeToolSpec[]
...
export interface SystemPromptContext {
	...
	readonly gitStatus?: {
		...
		readonly summary?: string // Short summary like "3 modified, 1 untracked"
	}
	readonly supportsBrowserUse?: boolean
	readonly mcpHub?: McpHub
	readonly skills?: SkillMetadata[]
	readonly focusChainSettings?: FocusChainSettings
	readonly globalSkycodeRulesFileInstructions?: string
	readonly localSkycodeRulesFileInstructions?: string
	...
	readonly skycodeIgnoreInstructions?: string
	...
	readonly skycodeWebToolsEnabled?: boolean
	...
	readonly alwaysThinkInPreferredLanguage?: boolean
...
export type ToolKey = keyof typeof SkycodeDefaultTool
export type ToolValue = (typeof SkycodeDefaultTool)[ToolKey]
...
export function isValidSkycodeDefaultTool(tool: string): tool is SkycodeDefaultTool {
	return Object.values(SkycodeDefaultTool).includes(tool as SkycodeDefaultTool)
}
...
export interface VariantBuilder {
	...
	tools(...tools: SkycodeDefaultTool[]): this
	overrideTool(tool: SkycodeDefaultTool, override: ConfigOverride): this
...
export const TASK_PROGRESS_PARAMETER = {
	...
	dependencies: [SkycodeDefaultTool.TODO],
}
