...
const baseContext: SystemPromptContext = {
	...
	focusChainSettings: { enabled: true, remindSkycodeInterval: 6 },
	browserSettings: { viewport: { width: 1280, height: 720 } },
	globalSkycodeRulesFileInstructions: "Follow global rules",
	localSkycodeRulesFileInstructions: "Follow local rules",
...
const contextVariations: Array<{ name: string; override: Partial<SystemPromptContext> }> = [
	...
	{ name: "no-focus-chain", override: { focusChainSettings: { enabled: false, remindSkycodeInterval: 0 } } },
]
...
const modelTestCases = [
	...
	{ family: ModelFamily.DEVSTRAL, modelId: "devstral", providerId: "skycode" },
	...
	{ family: ModelFamily.NATIVE_NEXT_GEN, modelId: "claude-4-5-sonnet", providerId: "skycode" },
