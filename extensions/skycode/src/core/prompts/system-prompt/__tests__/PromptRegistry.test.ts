	...
	describe("getModelFamily", () => {
		it("should extract correct model families", async () => {
			...
			const testCases = [
				...
				{ id: "qwen-max", provider: "lmstudio", expected: ModelFamily.QWEN },
				...
				{ id: "gpt-5", provider: "skycode", expected: ModelFamily.NATIVE_GPT_5, useNativeTools: true },
				{ id: "gpt-5", provider: "openai-native", expected: ModelFamily.NATIVE_GPT_5, useNativeTools: true },
				{ id: "gpt-5", provider: "skycode", expected: ModelFamily.GPT_5, useNativeTools: false },
