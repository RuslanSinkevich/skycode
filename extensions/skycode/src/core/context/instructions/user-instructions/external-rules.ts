...
export async function refreshExternalRulesToggles(
	...
	windsurfLocalToggles: SkycodeRulesToggles
	cursorLocalToggles: SkycodeRulesToggles
	agentsLocalToggles: SkycodeRulesToggles
}> {
 ...
 */
export const getLocalWindsurfRules = async (cwd: string, toggles: SkycodeRulesToggles) => {
 ...
 */
export const getLocalCursorRules = async (cwd: string, toggles: SkycodeRulesToggles) => {
 ...
 */
export const getLocalAgentsRules = async (cwd: string, toggles: SkycodeRulesToggles) => {
