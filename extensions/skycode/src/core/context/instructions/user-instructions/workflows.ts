...
export async function refreshWorkflowToggles(
	...
	const globalSkycodeWorkflowsFilePath = await ensureWorkflowsDirectoryExists()
	const updatedGlobalWorkflowToggles = await synchronizeRuleToggles(globalSkycodeWorkflowsFilePath, globalWorkflowToggles)
