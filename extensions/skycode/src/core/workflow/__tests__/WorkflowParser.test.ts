...
`,
	...
	describe("isMultiStepWorkflow", () => {
		...
		it("should handle full paths", () => {
			isMultiStepWorkflow("/home/user/.skycoderules/workflows/deploy.yaml").should.be.true()
			isMultiStepWorkflow("C:\\Users\\test\\.skycoderules\\workflows\\old.md").should.be.false()
		})
	})
