...
import { ResetStateRequest } from "@shared/proto/skycode/state"
...
export const SETTINGS_TABS: SettingsTab[] = [
	...
	{
		id: "indexing",
		nameKey: "settings.tabs.indexing.name",
		tooltipKey: "settings.tabs.indexing.tooltip",
		headerKey: "settings.tabs.indexing.header",
		icon: DatabaseZap,
	},
	{
		id: "mcp",
...
const SettingsView = ({ onDone, targetSection }: SettingsViewProps) => {
	...
	const TAB_CONTENT_MAP = useMemo(
		() => ({
			providers: ApiConfigurationSection,
			...
			voice: VoiceSection,
			indexing: IndexingSettingsSection,
			mcp: McpSection,
