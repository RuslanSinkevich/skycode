...
import { UpdateApiConfigurationRequestNew } from "@shared/proto/index.skycode"
		...
		<div>
			<DropdownContainer className="dropdown-container" style={{ position: "inherit" }}>
				<label htmlFor="moonshot-entrypoint">
					<span style={{ fontWeight: 500, marginTop: 5 }}>{t("provider.moonshotEntrypoint")}</span>
				</label>
				<VSCodeDropdown
			...
			<ApiKeyField
				helpText={t("provider.keyStoredLocally")}
