...
import { SapAiCoreModelDeployment } from "@shared/proto/index.skycode"
...
const SapAiCoreModelPicker: React.FC<SapAiCoreModelPickerProps> = ({
	...
	const categorizedModels = useMemo(() => {
		...
		// Models that are both deployed AND supported in Skycode
		...
		// Models that are supported in Skycode but NOT deployed
