					...
					<RestoreConfirmTooltip onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} ref={tooltipRef}>
						<RestoreOption>
							<VSCodeButton
								...
								{t("checkpoint.restoreTaskAndWorkspace")}
							</VSCodeButton>
							<p>{t("checkpoint.restoreTaskAndWorkspaceDesc")}</p>
						</RestoreOption>
						<RestoreOption>
							<VSCodeButton
							...
							<p>{t("checkpoint.restoreTaskOnlyDesc")}</p>
						</RestoreOption>
						<RestoreOption>
							<VSCodeButton
								...
								{t("checkpoint.restoreWorkspaceOnly")}
							</VSCodeButton>
							<p>{t("checkpoint.restoreWorkspaceOnlyDesc")}</p>
						</RestoreOption>
