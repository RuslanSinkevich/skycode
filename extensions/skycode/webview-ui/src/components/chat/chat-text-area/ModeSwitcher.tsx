	...
	return (
		<Tooltip>
			<TooltipContent
				...
				side="top">
				{shownTooltipMode &&
					`${t("chat.modePrefix")} ${t(`mode.${shownTooltipMode}`)} ${t("chat.modeSkycodeWill")} ${t(`chat.mode${shownTooltipMode.charAt(0).toUpperCase() + shownTooltipMode.slice(1)}Description` as any)}`}
