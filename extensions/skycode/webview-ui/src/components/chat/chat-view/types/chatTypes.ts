...
export interface ChatState {
	...
	// Derived values
	lastMessage: SkycodeMessage | undefined
	secondLastMessage: SkycodeMessage | undefined
	skycodeAsk: SkycodeAsk | undefined
	task: SkycodeMessage | undefined
