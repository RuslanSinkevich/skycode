 ...
 */
function buildToolsWithReasoning(messages: SkycodeMessage[]): ToolWithReasoning[] {
	...
	for (const msg of messages) {
		...
		if (msg.say === "reasoning" && msg.text) {
			...
			const parsedTool = isCommand
				? ({ tool: "command", path: "", content: msg.text } as SkycodeSayTool)
 ...
 */
function getToolDisplayInfo(tool: SkycodeSayTool, t: (key: string) => string) {
 ...
 */
function getToolGroupSummary(messages: SkycodeMessage[], t: (key: string) => string): string {
