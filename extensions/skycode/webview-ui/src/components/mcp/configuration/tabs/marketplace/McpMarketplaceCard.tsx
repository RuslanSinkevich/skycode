				...
				<div style={{ display: "flex", gap: "12px" }}>
					...
					<div
						...
						<div
							...
							<div
								...
								<StyledInstallButton $isInstalled={isInstalled} disabled={isInstalled || isDownloading}>
									{isInstalled ? t("mcp.installed") : isDownloading ? t("mcp.installing") : t("mcp.install")}
								</StyledInstallButton>
							</div>
						</div>
						...
						<div
							...
							{item.requiresApiKey && (
								<span className="codicon codicon-key" style={{ flexShrink: 0 }} title={t("mcp.requiresApiKey")} />
							)}
						</div>
					</div>
				</div>
				...
				<div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
					{/* {!item.isRecommended && (
						<div
							...
							<span>{t("mcp.communityMadeUseAtYourOwnRisk")}</span>
						</div>
					)} */}
