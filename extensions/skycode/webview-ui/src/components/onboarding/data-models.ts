import type { OpenRouterModelInfo } from "@shared/proto/skycode/models"
import type { OnboardingModel, OnboardingModelGroup } from "@shared/proto/skycode/state"
...
export function getSkycodeUIOnboardingGroups(groupedModels: OnboardingModelGroup): OnboardingModelsByGroup {
