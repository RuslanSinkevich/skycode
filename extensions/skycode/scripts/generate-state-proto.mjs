 ...
 *
 * The generated proto content is written to proto/skycode/state.proto,
...
const STATE_PROTO_PATH = "proto/skycode/state.proto"
...
function parseSecretsKeys(sourceFile) {
	...
	for (const element of initializer.getElements()) {
		...
		// Skip prefixed keys like "skycode:skycodeAccountId"
		if (!key.includes(":")) {
			keys.push(key)
		}
	}
