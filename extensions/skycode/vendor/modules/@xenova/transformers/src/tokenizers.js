...
// [SKYCODE] Replaced @huggingface/jinja with a lightweight stub.
// Template is only used for chat_template rendering which we don't need for embeddings.
const Template = class { constructor() {} render() { return ""; } };
