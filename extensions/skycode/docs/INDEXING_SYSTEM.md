# Skycode AI — Система индексации кодовой базы
...
Индекс хранится локально в `~/.skycode/indexing/{workspace-hash}/`.
...
| Команда | ID | Описание |
|---------|------|----------|
| Переиндексировать | `skycode.indexing.reindex` | Полная переиндексация |
| Очистить индекс | `skycode.indexing.clear` | Удаление всего индекса |
| Приостановить | `skycode.indexing.pause` | Пауза индексации |
| Продолжить | `skycode.indexing.resume` | Возобновление после паузы |
