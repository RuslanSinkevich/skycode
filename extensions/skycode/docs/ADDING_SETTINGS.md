# Добавление настроек в Skycode AI

Это руководство описывает полный процесс добавления новой настройки в расширение Skycode AI.

## Обзор архитектуры

Настройки в Skycode AI проходят через несколько слоёв:
...
- `src/shared/proto/skycode/state.ts`
...
myNewSetting: vscode.workspace.getConfiguration("skycode").get<boolean>("myNewSetting", true),
```
