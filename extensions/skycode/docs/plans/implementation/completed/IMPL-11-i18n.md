...
```json
{
	...
	"settings.about.tooltip": "О Skycode AI",
	...
	"chat.error": "Skycode AI столкнулся с проблемой...",
	"chat.askQuestion": "У Skycode AI есть вопрос:",
	"chat.wantsToExecute": "Skycode AI предлагает выполнить команду:",
	"chat.wantsToEdit": "Skycode AI хочет отредактировать файл:",
	"chat.wantsToCreate": "Skycode AI хочет создать новый файл:",
	"chat.wantsToDelete": "Skycode AI хочет удалить этот файл:",
	"chat.wantsToRead": "Skycode AI хочет прочитать этот файл:",
...
```json
{
	...
	"settings.about.tooltip": "About Skycode AI",
	...
	"chat.error": "Skycode AI encountered a problem...",
	"chat.askQuestion": "Skycode AI has a question:",
	"chat.wantsToExecute": "Skycode AI wants to execute a command:",
	"chat.wantsToEdit": "Skycode AI wants to edit a file:",
	"chat.wantsToCreate": "Skycode AI wants to create a new file:",
	"chat.wantsToDelete": "Skycode AI wants to delete this file:",
	"chat.wantsToRead": "Skycode AI wants to read this file:",
...
~56 строк — самый большой файл. Много контекстных сообщений ("Skycode AI хочет отредактировать файл:", "Skycode AI хочет создать новый файл:" и т.д.).
...
6. **Проверить чат:** все сообщения ("Skycode AI хочет...", кнопки) на выбранном языке
...
9. **Перезагрузить Skycode AI** — язык должен сохраниться (не сбрасываться на RU)
