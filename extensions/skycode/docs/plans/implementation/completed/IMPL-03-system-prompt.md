...
Запустить Skycode AI, отправить сообщение, в Output (Extension Host) увидеть длину правил. Должна быть больше чем раньше.

---

## Проверка

1. Собрать расширение, запустить Skycode AI
