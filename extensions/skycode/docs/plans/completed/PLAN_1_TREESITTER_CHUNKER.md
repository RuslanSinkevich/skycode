...
- WASM-файлы tree-sitter уже есть в проекте: `vscode/extensions/skycode/dist/tree-sitter-*.wasm`
...
1. Собрать расширение: `node esbuild.mjs` в `vscode/extensions/skycode/`
