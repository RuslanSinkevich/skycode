# Skycode AI — Inline Diff System v4
...
| `skycode.diff.nextHunk` | Следующий hunk (кросс-файловый) |
| `skycode.diff.prevHunk` | Предыдущий hunk (кросс-файловый) |
| `skycode.diff.clearAll` | Очистить все pending changes |
